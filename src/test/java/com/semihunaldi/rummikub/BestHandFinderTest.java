...
public class BestHandFinderTest {
	...
	public void testRandom() {
		for(int i = 0; i < 100_000; i++){
			...
			Assertions.assertThat(randomNumberInRange).isGreaterThanOrEqualTo(3).isLessThanOrEqualTo(100);
		}
	}
	...
	public void testFindBestHandWithPreBuiltHand3() {
		...
		preBuiltHandTest(3, handForTest1, handForTest2, handForTest3, handForTest4);
	}
